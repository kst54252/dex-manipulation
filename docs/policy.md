...
|---|---|
| `env.py`, `reference.py` | PhysX 환경·기준 궤적·reset |
| `task.py`, `observations.py` | action·보상·관측 |
| `curriculum.py`, `randomization.py` | RSI·중력·증강 |
| `grasp.py`, `grasp_v2.py` | 패드–캔 힘 측정·접근/접촉 보상 |
| `arm_env.py`, `arm_train.py` | 팔 연결 추론·학습 |
| `ppo.py`, `runner.py` | PPO·checkpoint·실행 |
